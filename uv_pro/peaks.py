...
def _preprocess_spectrum(spectrum: pd.DataFrame, p_win: tuple[int, int] | None = None,
                         s_win: int = 15) -> tuple[pd.DataFrame, np.ndarray]:
...
def _process_peaks(spectrum: pd.DataFrame, peaks: list[int], conc: float | None = None) -> dict:
